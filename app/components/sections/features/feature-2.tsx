    ...
    <div className="w-full py-24 sm:py-32">
      <div className="mx-auto max-w-7xl w-full px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-zinc-700 sm:text-5xl lg:text-balance">
        ...
        <div className="mx-auto mt-16 sm:mt-20 lg:mt-24 w-full">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            <div className="relative pl-16">
              <dt className="text-base/7 font-semibold text-zinc-700">
